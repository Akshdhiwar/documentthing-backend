...
func Cors() gin.HandlerFunc {
	...
	config.AllowOrigins = []string{"http://localhost:5173", "https://simpledocs.vercel.app", "https://www.documentthing.com", "https://documentthing.com", "http://localhost:5174"} // List specific origins
